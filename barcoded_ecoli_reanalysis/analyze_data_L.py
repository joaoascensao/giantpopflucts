...
Sfreq_tot=getfreqs('L')
Lfreq_tot=getfreqs('S')
Sfreq_solo=getfreqs_solo('L')
Lfreq_solo=getfreqs_solo('S')
...
plt.tight_layout()
#plt.show()
plt.savefig('fig1A_L.png',dpi=600)
...
plt.ylim((0.835,1))
plt.xlabel('Day')
plt.ylabel(r'Within-$L$ genotype frequency')
plt.tight_layout()
plt.savefig('fig1B_L.png',dpi=600)
